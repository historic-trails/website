...
{% include Fort-lennard-md.jpg class="img-right" width="33%" caption=" This image depicts a train on the recenly copleated santa fe rail road" src="images/Fort-lennard-md.jpg" %}
